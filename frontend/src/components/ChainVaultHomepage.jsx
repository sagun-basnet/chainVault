...
const ChainVaultHomepage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-gray-100 overflow-hidden">
      {/* Animated Background */}
      ...
      {/* Navigation */}
      <nav className="relative z-10 px-6 py-4 backdrop-blur-lg bg-black/20 border-b border-white/10">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <button className="bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 px-6 py-2 rounded-lg font-medium transition-all transform hover:scale-105">
              Get Started
            </button>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <FloatingElement delay={400}>
            <p className="text-xl md:text-2xl text-gray-300 mb-12 max-w-4xl mx-auto leading-relaxed">
              Manage, classify, and secure your files with AI and blockchain —
              no crypto needed.
            </p>
          </FloatingElement>
          ...
          <FloatingElement delay={600}>
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
              <button className="group bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 px-8 py-4 rounded-xl font-semibold text-lg transition-all transform hover:scale-105 flex items-center space-x-2">
                <span>Get Started</span>
                <ChevronRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
              </button>
              <button className="group border-2 border-cyan-400/50 hover:border-cyan-400 px-8 py-4 rounded-xl font-semibold text-lg transition-all backdrop-blur-sm hover:bg-cyan-400/10 flex items-center space-x-2">
          ...
          <FloatingElement delay={800}>
            <div className="relative mx-auto max-w-4xl">
              <div className="bg-gradient-to-br from-purple-900/20 to-blue-900/20 backdrop-blur-xl rounded-3xl border border-white/10 p-8 shadow-2xl">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                  {[...Array(8)].map((_, i) => (
                    <div
                      key={i}
                      className="bg-gradient-to-br from-cyan-500/20 to-blue-600/20 rounded-xl p-4 backdrop-blur-sm border border-cyan-400/20 hover:scale-105 transition-transform"
                    >
                      <div className="w-8 h-8 bg-gradient-to-br from-cyan-400 to-blue-600 rounded-lg mb-2 mx-auto"></div>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <FloatingElement key={index} delay={300 + index * 100}>
                <div className="group bg-gradient-to-br from-purple-900/20 to-blue-900/20 backdrop-blur-xl rounded-2xl p-6 border border-white/10 hover:border-cyan-400/50 transition-all hover:scale-105">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {steps.map((step, index) => (
              <FloatingElement key={index} delay={300 + index * 100}>
                <div
                  className={`relative bg-gradient-to-br from-purple-900/20 to-blue-900/20 backdrop-blur-xl rounded-2xl p-6 border transition-all ${
                    currentStep === index
                ...
                >
                  <div className="text-center">
                    ...
                    <div className="w-8 h-8 rounded-full bg-gradient-to-br from-cyan-500 to-blue-600 text-white font-bold flex items-center justify-center mx-auto mb-4">
                      {index + 1}
                    </div>
                  ...
                  {index < steps.length - 1 && (
                    <div className="hidden md:block absolute top-1/2 -right-4 text-cyan-400">
      ...
      <section className="relative z-10 px-6 py-20">
        <div className="max-w-4xl mx-auto">
          <FloatingElement delay={200}>
            <div className="bg-gradient-to-br from-purple-900/30 to-blue-900/30 backdrop-blur-2xl rounded-3xl p-12 border border-cyan-400/30 shadow-2xl text-center">
                ...
                <div className="bg-gray-900/50 rounded-xl p-4 border border-gray-700">
                  ...
                  <div className="grid grid-cols-3 gap-2 mb-4">
                    {[...Array(6)].map((_, i) => (
                      <div
                        key={i}
                        className="bg-gradient-to-br from-gray-800 to-gray-700 rounded-lg p-3 hover:scale-105 transition-transform cursor-pointer"
                      >
      ...
      <section className="relative z-10 px-6 py-20">
        <div className="max-w-4xl mx-auto text-center">
          <FloatingElement delay={200}>
            ...
            <button className="group bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 px-12 py-4 rounded-xl font-semibold text-xl transition-all transform hover:scale-105 flex items-center space-x-3 mx-auto">
      ...
      {/* Footer */}
      <footer className="relative z-10 px-6 py-16 border-t border-white/10 backdrop-blur-lg bg-black/20">
        <div className="max-w-6xl mx-auto">
